<template>
    <div class="LatestJobs" :dir="currentLang === 'ar' ? 'rtl' : 'ltr'" :class="currentLang === 'ar' ? 'rtl' : 'ltr'">
        <div class="header-Operators">
          ...
          <div class="container">
            <div class="title-Operators">
              <h2>{{ text.latestJobsPage.title }}</h2>
              <p>{{ text.latestJobsPage.breadcrumb }}</p>
            </div>
          </div>
        </div>

        <div class="container">
            <div class="row filter-job-row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="job-list">
                        <div class="job-card-wide" v-for="(job, index) in paginatedJobs" :key="index">
...
<script>
import latestJobs from '@/scripts/LatestJobs.js'
